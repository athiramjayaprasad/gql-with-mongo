...
func (ec *executionContext) field_Mutation_createJobListing_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNCreateJobListingInput2githubᚗcomᚋathiramjayaprasadᚋgqlᚑwithᚑmongoᚋgraphᚋmodelᚐCreateJobListingInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) field_Mutation_updateJobListing_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
		arg1, err = ec.unmarshalNUpdateJobListingInput2githubᚗcomᚋathiramjayaprasadᚋgqlᚑwithᚑmongoᚋgraphᚋmodelᚐUpdateJobListingInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createJobListing(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNJobListing2ᚖgithubᚗcomᚋathiramjayaprasadᚋgqlᚑwithᚑmongoᚋgraphᚋmodelᚐJobListing(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_deleteJobListing(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNDeleteJobResponse2ᚖgithubᚗcomᚋathiramjayaprasadᚋgqlᚑwithᚑmongoᚋgraphᚋmodelᚐDeleteJobResponse(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalNCreateJobListingInput2githubᚗcomᚋathiramjayaprasadᚋgqlᚑwithᚑmongoᚋgraphᚋmodelᚐCreateJobListingInput(ctx context.Context, v interface{}) (model.CreateJobListingInput, error) {
	res, err := ec.unmarshalInputCreateJobListingInput(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNDeleteJobResponse2githubᚗcomᚋathiramjayaprasadᚋgqlᚑwithᚑmongoᚋgraphᚋmodelᚐDeleteJobResponse(ctx context.Context, sel ast.SelectionSet, v model.DeleteJobResponse) graphql.Marshaler {
	return ec._DeleteJobResponse(ctx, sel, &v)
}

func (ec *executionContext) marshalNDeleteJobResponse2ᚖgithubᚗcomᚋathiramjayaprasadᚋgqlᚑwithᚑmongoᚋgraphᚋmodelᚐDeleteJobResponse(ctx context.Context, sel ast.SelectionSet, v *model.DeleteJobResponse) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNJobListing2githubᚗcomᚋathiramjayaprasadᚋgqlᚑwithᚑmongoᚋgraphᚋmodelᚐJobListing(ctx context.Context, sel ast.SelectionSet, v model.JobListing) graphql.Marshaler {
...
func (ec *executionContext) unmarshalNUpdateJobListingInput2githubᚗcomᚋathiramjayaprasadᚋgqlᚑwithᚑmongoᚋgraphᚋmodelᚐUpdateJobListingInput(ctx context.Context, v interface{}) (model.UpdateJobListingInput, error) {
